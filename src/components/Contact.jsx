...
  // Helper function to safely get the Web3Forms API key
  const getApiKey = () => {
...
    try {
      // 1. Save directly into Supabase 'leads' table
...
      // 2. Submit to Web3Forms for email notifications
      const apiKey = getApiKey();
      const payload = new FormData();
      payload.append("access_key", apiKey);
      payload.append("subject", `New Lead from HB GrowthSyncro : ${fullName}`);
