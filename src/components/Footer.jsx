  ...
  return (
    <footer className="bg-slate-50 text-slate-700 pt-16 pb-8 border-t border-slate-200">
          ...
          <ul className="space-y-2 text-xs sm:text-sm pt-1">
            <li>
              <Link to="/" className="hover:text-blue-600 transition-colors flex items-center gap-1.5">
                <span className="text-blue-600 text-xs">›</span> Home
              </Link>
            </li>
            <li>
              <Link to="/about" className="hover:text-blue-600 transition-colors flex items-center gap-1.5">
                <span className="text-blue-600 text-xs">›</span> About Us
              </Link>
            </li>
            <li>
              <Link to="/services" className="hover:text-blue-600 transition-colors flex items-center gap-1.5">
                <span className="text-blue-600 text-xs">›</span> Services
              </Link>
            </li>
            <li>
              <Link to="/portfolio" className="hover:text-blue-600 transition-colors flex items-center gap-1.5">
                <span className="text-blue-600 text-xs">›</span> Portfolio
              </Link>
            </li>
            <li>
              <Link to="/pricing" className="hover:text-blue-600 transition-colors flex items-center gap-1.5">
                <span className="text-blue-600 text-xs">›</span> Pricing
              </Link>
            </li>
            <li>
              <Link to="/blog" className="hover:text-blue-600 transition-colors flex items-center gap-1.5">
                <span className="text-blue-600 text-xs">›</span> Blog
              </Link>
            </li>
            <li>
              <Link to="/faq" className="hover:text-blue-600 transition-colors flex items-center gap-1.5">
                <span className="text-blue-600 text-xs">›</span> FAQ
              </Link>
            </li>
            <li>
              <Link to="/contact" className="hover:text-blue-600 transition-colors flex items-center gap-1.5">
                <span className="text-blue-600 text-xs">›</span> Contact
              </Link>
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-xs sm:text-sm text-slate-600 pt-1">
            <li className="flex justify-between border-b border-slate-200 pb-1.5">
              <span>Mon - Sat:</span>
              <span className="text-blue-600 font-semibold">10:00 AM - 7:00 PM</span>
            </li>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-3 text-xs sm:text-sm text-slate-600 pt-1">
            <li className="flex items-center gap-2.5">
              ...
              <a href="tel:+918080224138" className="hover:text-blue-600 transition font-medium">
                +91 8080224138
              </a>
            </li>
            <li className="flex items-center gap-2.5">
              ...
              <a href="mailto:hbgrowthsyncro@gmail.com" className="hover:text-blue-600 transition font-medium">
      ...
      <div className="mt-12 pt-6 border-t border-slate-200 text-center text-xs text-slate-500 max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p>Copyright © 2026 <span className="text-slate-900 font-bold">HB GrowthSyncro</span>, India. All Rights Reserved.</p>
        <p className="text-[11px] text-blue-600 font-medium">Web Design, Development & Digital Marketing Agency</p>
      </div>
    </footer>
  );
};
